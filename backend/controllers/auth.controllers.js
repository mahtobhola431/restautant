...
const setAuthCookie = (req, res, token) => {
  // Detect if running on HTTPS (Render, Vercel, etc.)
  const isHttps = req.secure || req.headers["x-forwarded-proto"] === "https";

  res.cookie("token", token, {
    httpOnly: true,
    secure: isHttps,                // true for HTTPS, false for localhost (HTTP)
    sameSite: isHttps ? "none" : "lax", // 'none' for cross-domain HTTPS
